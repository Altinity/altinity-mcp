...
LOCAL_PID="$(start_local_mcp "${SCRIPT_DIR}/start-local-broker.sh" "${LOCAL_LOG}")"
...
echo "Running broker-mode verification query against github.demo.altinity.cloud..."
